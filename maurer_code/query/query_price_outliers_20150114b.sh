...
cd $MY_PATH
FNAME='query_price_outliers_20150114b'
...
FROM 
    sales_extended2
WHERE
	(mm_fips_muni_code = 1 AND val_sqft_adj > 1054)
	OR (mm_fips_muni_code = 13 AND val_sqft_adj > 794)
	OR (mm_fips_muni_code = 41 AND val_sqft_adj > 1788)
	OR (mm_fips_muni_code = 55 AND val_sqft_adj > 1577)
	OR (mm_fips_muni_code = 75 AND val_sqft_adj > 2014)
	OR (mm_fips_muni_code = 81 AND val_sqft_adj > 1773)
	OR (mm_fips_muni_code = 85 AND val_sqft_adj > 1354)
	OR (mm_fips_muni_code = 95 AND val_sqft_adj > 729)
	OR (mm_fips_muni_code = 97 AND val_sqft_adj > 1260)
    AND RANDOM() < 0.01
